...
public class HouseInsuranceAgreementBuilder implements IInsuranceAgreementBuilder{
    private Random ran = new Random();

    private InsuranceAgreement insAgreement;

    public HouseInsuranceAgreementBuilder(){
        insAgreement = new InsuranceAgreement();
    }

    @Override
    public void buildClientNameAndType() {
        this.insAgreement.setType("house");
    ...
    public void buildInsuranceAmount() {
        ...
        this.insAgreement.setEndYear(ran.nextInt(10)+HardCodedValue.currentYear);
